...
CREATE TABLE `worker_availability` (
  `availiblity_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `available_start` datetime DEFAULT NULL,
  `available_end` datetime DEFAULT NULL,
  `status` enum('Available','Booked','Annual_Leave') DEFAULT NULL,
  PRIMARY KEY (`availiblity_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `worker_availability_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `worker_availability` VALUES (1,5,'2026-04-01 09:00:00','2026-04-01 17:00:00','Booked'),(2,5,'2026-04-03 09:00:00','2026-04-03 17:00:00','Booked'),(3,5,'2026-04-06 09:00:00','2026-04-06 17:00:00','Booked'),(4,5,'2026-04-07 09:00:00','2026-04-07 17:00:00','Booked');
...
-- Dump completed on 2026-04-01 14:47:12
