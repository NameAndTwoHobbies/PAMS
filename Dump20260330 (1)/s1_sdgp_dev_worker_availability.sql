...
CREATE TABLE `worker_availability` (
  `availiblity_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `available_start` datetime DEFAULT NULL,
  `available_end` datetime DEFAULT NULL,
  `status` enum('Available','Booked','Annual_Leave') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `worker_availability` VALUES (1,5,'2026-04-01 09:00:00','2026-04-01 17:00:00','Booked');
